...
def get_rating_info(in_file):
    ...
    with open(in_file) as fin:
        ...
        average_rating = total_rating / float(line_num)

        return highest_item, highest_rating, average_rating
...
if __name__ == "__main__":
    ...
    for rating_file in ratings_lists:
        highest_item, highest_rating, average_rating = get_rating_info(rating_file)
        print "The highest rated item in {} was {} with a score of {}".format(rating_file, highest_item, highest_rating)
        print "The average rating in {} was {}".format(rating_file, average_rating)
        print 
    pass
